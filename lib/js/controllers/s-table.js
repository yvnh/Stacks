(function () {
    ...
    function ensureIndicatorIcons(element) {
        var present = element.querySelectorAll(".js-sorting-indicator");
        if (present.length < 3) {
            [["asc", "ArrowUpSm"], ["desc", "ArrowDownSm"], ["none", "ArrowUpDownSm"]].forEach(function (t) {
                if (element.querySelector(".js-sorting-indicator-" + t[0])) {
                    return;
                }
                var hideClass = present.length || t[0] !== "none" ? " d-none" : "";
                var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
                svg.setAttribute("class", "js-sorting-indicator js-sorting-indicator-" + t[0] + hideClass);
                svg.setAttribute("data-controller", "s-icon");
                svg.setAttribute("data-s-icon-name", t[1]);
                element.appendChild(svg);
            });
            present = element.querySelectorAll(".js-sorting-indicator");
        }
        return present;
    }
    ...
    Stacks.addController("s-table", {
        ...
        connect: function () {
            this.columnTargets.forEach(ensureIndicatorIcons);
        },
        ...
        setCurrentSort: function (headElem, direction) {
            ...
            this.columnTargets.forEach(function (target) {
                ...
                ensureIndicatorIcons(target).forEach(function (icon) {
